...
def create_docker_compose(args):
    ...
    client_configs = [
    {"mem_limit": "256m", "batch_size": 8, "cpus": 0.5, "learning_rate": 0.001},
    {"mem_limit": "512m", "batch_size": 16, "cpus": 0.75, "learning_rate": 0.005},
    {"mem_limit": "384m", "batch_size": 12, "cpus": 0.6, "learning_rate": 0.002},
    {"mem_limit": "128m", "batch_size": 4, "cpus": 0.25, "learning_rate": 0.0005}
    # {"mem_limit": "1g", "batch_size": 32, "cpus": 1, "learning_rate": 0.001},
